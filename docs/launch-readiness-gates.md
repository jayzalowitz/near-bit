...
- `2026-03-16`: Re-baselined launch-window signoff to release candidate `94bd80ef1` and launch window `2026-03-20T18:00:00Z` to `2026-03-20T22:00:00Z` in `docs/mainnet-go-no-go-checklist.md`.
...
- `2026-03-16`: Post-refresh reconfirmation reruns passed locally:
  ...
  - `./scripts/launch/run_launch_rehearsal.sh --mode full --require-go --include-release-manifest --allow-dirty --operator launch-readiness --check-nightly-fuzz-health --nightly-fuzz-branch infinitoshi/btc-near-fork-plan --nightly-fuzz-workflow CI --nightly-fuzz-window-days 7 --nightly-fuzz-min-runs 1 --nightly-fuzz-max-runs 50 --nightly-fuzz-job-pattern "Fuzz" --cargo-target-dir .context/cargo-target-launch` (artifact: `artifacts/launch-rehearsals/20260316T212521Z-94bd80ef1`)
