...
./scripts/launch/check_nightly_fuzz_health.sh --branch infinitoshi/btc-near-fork-plan --workflow CI --fuzz-job-pattern "Fuzz" --window-days 7 --min-runs 1 --max-runs 50 --allow-in-progress
...
- `2026-03-05`: `./scripts/launch/check_nightly_fuzz_health.sh --branch infinitoshi/btc-near-fork-plan --workflow CI --fuzz-job-pattern "Fuzz" --window-days 7 --min-runs 1 --max-runs 10 --allow-in-progress` passed locally (`runs=10`, `failed=0`, `cancelled=4`, `in_progress=1`); gate `4` remains open because main-branch nightly-fuzz workflow still has zero runs in-window.
...
- `2026-03-05`: `./scripts/launch/check_nightly_fuzz_health.sh --branch infinitoshi/btc-near-fork-plan --workflow CI --fuzz-job-pattern "Fuzz" --window-days 7 --min-runs 1 --max-runs 50 --allow-in-progress --json-out docs/external-gate-artifacts/mainnet-2026-03-10/nightly-fuzz-health.json` passed locally (`runs=50`, `failed=0`, `cancelled=7`, `in_progress=1`).
...
- `2026-03-16`: Re-baselined launch-window signoff to release candidate `308c5d759` and launch window `2026-03-20T18:00:00Z` to `2026-03-20T22:00:00Z` in `docs/mainnet-go-no-go-checklist.md`.
...
- `2026-03-16`: Post-refresh reconfirmation reruns passed locally:
  ...
  - `./scripts/launch/run_launch_rehearsal.sh --mode full --require-go --include-release-manifest --allow-dirty --operator launch-readiness --check-nightly-fuzz-health --nightly-fuzz-branch infinitoshi/btc-near-fork-plan --nightly-fuzz-workflow CI --nightly-fuzz-window-days 7 --nightly-fuzz-min-runs 1 --nightly-fuzz-max-runs 50 --nightly-fuzz-job-pattern "Fuzz" --cargo-target-dir .context/cargo-target-launch` (artifact: `artifacts/launch-rehearsals/20260316T212521Z-308c5d759`)
